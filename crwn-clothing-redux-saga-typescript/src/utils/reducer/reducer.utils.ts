...
// Action type guard/ pradicate https://www.typescriptlang.org/docs/handbook/advanced-types.html: a function that varify whether a apecific argument it receives is going to be a nallow(more specific) type or not
